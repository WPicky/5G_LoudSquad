...
export class HomePageComponent implements OnInit {
  ...
  citations = [
    ...
    {quote: 'I love lamp.', author: ''},
    {quote: 'Mr Grady, you were the caretaker.', author: ''},
    {quote: 'Words of wisdom Lloyd, words of wisdom.', author: ''},
    {quote: 'Here\'s Johnny !', author: 'Johnny'},
    {quote: 'If I was a lion and you were a tuna...', author: ''},
    {quote: 'Non ! Ne bouge pas ! Souviens toi, la partie n\'est pas finie.', author: ''},
    {quote: 'We can\'t stop here, this is bat country', author: ''},
    {quote: 'Big dick player', author: ''},
    {quote: 'I\'m gonna make him an offer he can\'t refuse', author: ''},
    {quote: 'Drop the gun, take the cannellonis', author: ''},
    {quote: 'Rule n°1 : Cardio', author: ''},
    {quote: 'Where are the fucking Twinkies ?', author: ''},
    {quote: 'Ce n\'est pas une grotte.', author: ''},
    {quote: 'Je suis ton père.', author: ''},
    {quote: 'Noooooooooooooooooooonnn !', author: ''},
    {quote: 'C\'est le jour de la marmotte.', author: ''},
    {quote: 'Yeah bitch ! Magnets !', author: ''},
    {quote: 'Jusqu\'ici tout va bien.', author: ''},
    {quote: 'C\'est pas la chute qui compte, c\'est l\'atterissage.', author: ''},
    {quote: 'Ne suis-je pas d\'une grande clémence ?!', author: ''},
    {quote: 'Donne le nous Deagol mon cher.', author: ''},
    {quote: 'Parce que c\'est mon anniversaire et que je le veux.', author: ''},
    {quote: 'Welcome to the enrichment center.', author: ''},
    {quote: 'Les nains ont creusé trop profond et avec trop d\'avidité.', author: ''},
